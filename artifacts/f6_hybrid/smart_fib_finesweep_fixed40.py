"""Fine sweep around the Smart Fib Optimus champion, fixed Rs40/trade cost.

Sweeps exit axes only: targets (0.382, 0.5, 0.618) x stops (1.05..1.30 step 0.025),
...
def _params():
    targets = (0.382, 0.5, 0.618)
    stops = tuple(round(1.05 + 0.025 * i, 3) for i in range(11))
    out = []
...
def main(argv=None):
    ...
    parser.add_argument("--output", default="artifacts/f6_hybrid/smart_fib_finesweep_fixed40.json")
    ...
    result = {
        "engine": "smart_fib_finesweep_fixed40",
        "mode": "fine_sweep_fixed40",

"""
MARNI VSA / PURE SPOT-OPTION 7-YEAR MULTI-YEAR BACKTEST ENGINE (2020 - 2026)
=============================================================================
Strategy Name: Marni VSA Engine (Pure Spot Index + Option Contracts)
Author: Pair Programmed with User & Antigravity
Data Inputs:
  - Spot Index: NIFTY 50 1-Minute Cash Index (Swings, Golden Pocket, 15m HTF Gate)
  - Options: 1-Minute Option Contracts (ATM-100 CE / ATM+100 PE)
Specifications:
  1. Mirrored 1m 3-Phase Impulse Waves on NIFTY Spot (Span >= 20.0 pts)
  2. Fibonacci Retracement Discount Pocket [0.618 - 0.786] on Spot
  3. 15-Minute HTF Trend Gate (15m Heikin-Ashi + 11-period LinReg Plot + 15m UT Bot)
  4. Single Execution per Impulse Wave (Strict Causal State Machine)
  5. Target TP: 0.786 Retest | Stop Loss SL: 1.155 Extension | 15:00 EOD
  6. Real-world Friction: ₹15/order Brokerage + 0.50 pt/trade Slippage
"""
...
def process_day(task):
    ...
    # Warmup 15m HTF bias on previous day spot
...
def main():
    parser = argparse.ArgumentParser(description="Marni Pure Spot-Options 7-Year Backtest Engine")
    ...
    parser.add_argument("--output", default="artifacts/f6_hybrid/marni_spot_options_7y_results.json")
    args = parser.parse_args()

    include_fees = not args.no_fees
    print(f"\n{'='*100}")
    print(f"MARNI ENGINE — PURE SPOT INDEX + OPTION CONTRACTS 7-YEAR BACKTEST (2020 - 2026)")
